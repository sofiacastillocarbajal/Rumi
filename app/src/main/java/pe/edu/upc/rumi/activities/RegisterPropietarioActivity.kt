...
class RegisterPropietarioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_propietario)
                ...
                object: ParsedRequestListener<LoginResponse> {
                    override fun onResponse(response: LoginResponse?) {
                        response?.apply {
                            ...
                            UserDefaults.saveInSharedPreferences(this@RegisterPropietarioActivity)
...
//        dialog.show()
    ...
    fun goToMainPropietario() {
        val intent = Intent(this, MainPropietarioActivity::class.java)
